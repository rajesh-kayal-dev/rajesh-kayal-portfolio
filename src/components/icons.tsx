...
export const Icons = {
  ...
  x: (props: IconProps) => (
    <svg viewBox="0 0 512 512" fill="currentColor" stroke="currentColor" strokeWidth="0" {...props}>
  ...
  nodejs: (props: IconProps) => (
    <svg role="img" viewBox="0 0 256 292" fill="#339933" {...props}>
      <title>Node.js</title>
      <path d="M134.923 1.832c-4.344-2.443-9.502-2.443-13.846 0L6.787 67.801C2.443 70.244 0 74.859 0 79.745v132.208c0 4.887 2.715 9.502 6.787 11.945l114.29 65.968c4.344 2.444 9.502 2.444 13.846 0l114.29-65.968c4.344-2.443 6.787-7.058 6.787-11.945V79.745c0-4.886-2.715-9.501-6.787-11.944L134.923 1.832Z" />
    </svg>
  ),
  docker: (props: IconProps) => (
    <svg role="img" viewBox="0 0 24 24" fill="#2496ED" {...props}>
      <title>Docker</title>
  ...
  mongodb: (props: IconProps) => (
    <svg role="img" viewBox="0 0 24 24" fill="#47A248" {...props}>
      <title>MongoDB</title>
      <path d="M17.193 9.555c-1.134-4.503-4.257-8.461-4.854-9.213a.35.35 0 0 0-.583.011c-.559.78-3.322 4.67-4.244 8.784-.962 4.29.356 8.356 2.053 10.15l-.014.013 1.134 2.19c.144.27.53.273.678.004l1.11-2.09c1.92-1.741 3.593-5.59 2.72-10.205zM12.33 19.35c-1.398-1.584-3.076-5.467-2.106-9.78.89-3.961 3.235-7.391 3.733-8.084.536.721 2.502 3.822 3.296 7.641.874 4.216-1.121 8.016-2.583 9.487l-1.171.745-.333-.42c-.084-.108-.344-.452-.486-.613l-.35-.486z" />
    </svg>
  ),
  firebase: (props: IconProps) => (
    <svg role="img" viewBox="0 0 24 24" fill="#FFCA28" {...props}>
      <title>Firebase</title>
      <path d="M3.89 15.672L6.255.461A.545.545 0 0 1 7.27.277l2.588 4.844L3.89 15.672zm16.22 0l-2.365-15.21a.545.545 0 0 0-1.015-.184l-2.588 4.844 5.968 10.55zm-8.11 0l2.588-4.844-5.176 0 2.588 4.844zm-8.11 0l2.588-4.844-5.176 0 2.588 4.844z" />
    </svg>
  ),
  aws: (props: IconProps) => (
    <svg role="img" viewBox="0 0 24 24" fill="#FF9900" {...props}>
      <title>AWS</title>
      <path d="M14.654 11.233c-.02-.132-.1-.23-.232-.244-.22-.03-.435-.044-.652-.04-.543-.013-1.085-.013-1.627 0-.256 0-.5.066-.713.204-.37.24-.51.706-.32 1.1.2.403.65.6 1.08.47.165-.05.3-.153.407-.294.2-.262.4-.262.6-.013.136.173.27.34.407.51.135.16.07.38-.08.5-.164.135-.357.23-.55.293-1.294.4-2.614.414-3.91.04-.15-.043-.284-.132-.373-.264-.176-.25-.336-.505-.487-.764-.083-.146-.118-.31-.1-.475-.02-.294.043-.586.19-.85.5-.9 1.4-1.39 2.4-1.31.42.015.84.037 1.258.07.135.012.23-.083.245-.213.012-.13-.082-.25-.213-.265-.434-.037-.872-.056-1.31-.056-.475 0-.95.044-1.42.146-.66.136-1.255.485-1.69 1-.41.51-.595 1.144-.52 1.78.076.6.35 1.15.776 1.58.116.12.247.23.385.33l.03-.014a1.737 1.737 0 011.083.567c.32.324.503.765.513 1.23-.003.486-.2.95-.547 1.293-.343.344-.805.542-1.29.543-.193 0-.38-.035-.55-.1a1.734 1.734 0 01-1.08-1.583 1.745 1.745 0 011.75-1.745c.133 0 .26.015.385.045.133.03.27-.052.3-.182.03-.13-.05-.27-.18-.3-.16-.04-.33-.06-.5-.06a2.245 2.245 0 100 4.49c.613 0 1.19-.24 1.62-.676.43-.435.67-1.02.67-1.63 0-.616-.246-1.206-.683-1.643-.145-.145-.308-.27-.482-.373.16-.135.32-.27.48-.405.28-.23.6-.39.95-.48.45-.11.91-.16 1.38-.15.42 0 .84.03 1.26.08.13.02.25-.07.27-.2z" />
    </svg>
  ),
  figma: (props: IconProps) => (
    <svg role="img" viewBox="0 0 24 24" fill="#F24E1E" {...props}>
      <title>Figma</title>
      <path d="M12 0a4 4 0 0 0-4 4 4 4 0 0 0 4 4 4 4 0 0 0 4-4 4 4 0 0 0-4-4zm-4 8a4 4 0 0 0-4 4 4 4 0 0 0 4 4 4 4 0 0 0 4-4 4 4 0 0 0-4-4zm8 0a4 4 0 0 0-4 4 4 4 0 0 0 4 4 4 4 0 0 0 4-4 4 4 0 0 0-4-4zm-8 8a4 4 0 0 0-4 4 4 4 0 0 0 4 4 4 4 0 0 0 4-4 4 4 0 0 0-4-4zm4 0a4 4 0 0 0 4 4 4 4 0 0 1-4 4 4 4 0 0 1-4-4 4 4 0 0 1 4-4z" />
    </svg>
  ),
  redis: (props: IconProps) => (
    <svg role="img" viewBox="0 0 24 24" fill="#DC382D" {...props}>
      <title>Redis</title>
      <path d="M22.062 10.158l-1.93-1.114V4.912l1.93-1.114 1.938 1.114v4.132l-1.938 1.114zM10.062 20.158l-1.93-1.114v-4.132l1.93-1.114 1.938 1.114v4.132l-1.938 1.114zM10.062 10.158l-1.93-1.114V4.912l1.93-1.114 1.938 1.114v4.132l-1.938 1.114z" />
    </svg>
  ),
  shadcn: (props: IconProps) => (
    <svg role="img" viewBox="0 0 24 24" fill="currentColor" {...props}>
      <title>shadcn/ui</title>
      <path d="M24 0H0v24h24V0zM12 18.5L5.5 12 12 5.5l6.5 6.5-6.5 6.5z" />
    </svg>
  ),
  redux: (props: IconProps) => (
    <svg role="img" viewBox="0 0 24 24" fill="#764ABC" {...props}>
      <title>Redux</title>
      <path d="M12 0L2.1 5.1v10.3L12 20.5l9.9-5.1V5.1L12 0zm0 18.5L4.1 14.5V6.5L12 2.5l7.9 4v8L12 18.5z" />
    </svg>
  ),
  gcp: (props: IconProps) => (
    <svg role="img" viewBox="0 0 24 24" {...props}>
      <title>Google Cloud</title>
      <path d="M12 0L3.1 5.1v10.3L12 20.5l8.9-5.1V5.1L12 0z" fill="#4285F4" />
      <path d="M12 0L3.1 5.1v10.3L12 20.5z" fill="#34A853" fillOpacity="0.8" />
      <path d="M12 0L20.9 5.1v10.3L12 20.5z" fill="#EA4335" fillOpacity="0.8" />
      <path d="M3.1 15.4L12 20.5l8.9-5.1z" fill="#FBBC05" fillOpacity="0.8" />
    </svg>
  ),
  postgresql: (props: IconProps) => (
    <svg role="img" viewBox="0 0 24 24" fill="#336791" {...props}>
      <title>PostgreSQL</title>
      <path d="M12.42 2.1c-.81 0-1.61.12-2.38.35C5.78 3.73 2.08 7.43.81 11.69c-.4 1.34-.61 2.73-.61 4.14 0 4.14 1.83 8.01 5.04 10.59 1.13.84 2.37 1.48 3.69 1.91 1.25.39 2.55.59 3.86.59h.56c1.1-.03 2.21-.18 3.28-.45 4.36-1.13 7.84-4.57 9.17-8.91.41-1.34.61-2.73.61-4.14 0-1.12-.13-2.24-.38-3.33-1.07-4.71-4.79-8.47-9.5-9.61-.71-.17-1.42-.27-2.14-.27z" />
    </svg>
  ),
  express: (props: IconProps) => (
    <svg role="img" viewBox="0 0 24 24" fill="currentColor" {...props}>
      ...
      <path d="M24 0H0v24h24V0zM12 18.5L5.5 12 12 5.5l6.5 6.5-6.5 6.5z" />
      <text x="50%" y="55%" dominantBaseline="middle" textAnchor="middle" fill="#fff" fontSize="8" fontWeight="bold">EX</text>
    </svg>
  ),
  n8n: (props: IconProps) => (
    <svg role="img" viewBox="0 0 24 24" fill="#FF6D5A" {...props}>
      <title>n8n</title>
      <path d="M12 2L4 7v10l8 5 8-5V7l-8-5zm0 18l-6-3.75V7.75L12 4l6 3.75v8.5L12 20z" />
      <circle cx="12" cy="12" r="3" />
    </svg>
  ),
  dsa: (props: IconProps) => (
    <svg role="img" viewBox="0 0 24 24" fill="#60A5FA" {...props}>
      <title>DSA</title>
      <path d="M12 2L4 7v10l8 5 8-5V7l-8-5z" fill="none" stroke="currentColor" strokeWidth="1.5" />
      <circle cx="12" cy="7" r="1.5" fill="currentColor" />
      <circle cx="7" cy="14" r="1.5" fill="currentColor" />
      <circle cx="17" cy="14" r="1.5" fill="currentColor" />
      <path d="M12 8.5v4M7.5 14.5l4 4M16.5 14.5l-4 4" stroke="currentColor" strokeWidth="1.2" />
    </svg>
  ),
  vibecoding: (props: IconProps) => (
    <svg role="img" viewBox="0 0 24 24" {...props}>
      <title>Vibe Coding</title>
      <rect width="20" height="16" x="2" y="4" rx="2" fill="#1E1E1E" />
      <path d="M7 9l-2 3 2 3M17 9l2 3-2 3M11 8l2 8" stroke="#FF00FF" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M18 6a2 2 0 11-4 0 2 2 0 014 0z" fill="#00FFFF" />
  ...
  python: (props: IconProps) => (
    <svg role="img" viewBox="0 0 24 24" fill="#3776AB" {...props}>
      <title>Python</title>
      <path d="M14.25.18l.9.2.73.26.59.3.45.32.34.34.25.34.16.33.1.3.04.26.02.2-.01.13V8.5h-8V6.42h5V4.92h-5V3.42h-3.5l-.13.01-.26.04-.3.1-.33.16-.34.25-.32.34-.3.45-.26.59-.2.73-.1.9-.04 1.1-.01.2v11.05l.01.13.04.26.1.3.16.33.25.34.34.32.45.3.59.26.73.2.9.1 1.1.04.2.01h8.05l.13-.01.26-.04.3-.1.33-.16.34-.25.32-.34.3-.45.26-.59.2-.73.1-.9.04-1.1.01-.2v-2.05h-5v-1.5h5v-1.5h3.5l.13-.01.26-.04.3-.1.33-.16.34-.25.32-.34.3-.45.26-.59.2-.73.1-.9.04-1.1.01-.2V.18z" />
    </svg>
  ),
  anthropic: (props: IconProps) => (
    <svg role="img" viewBox="0 0 24 24" fill="#D97757" {...props}>
      <title>Claude / Anthropic</title>
      <path d="M13.432 3.125h-2.864L4.85 20.875h2.864l1.378-3.791h5.816l1.378 3.791h2.864L13.432 3.125zm-3.447 13.959l2.015-5.542 2.015 5.542h-4.03z" />
    </svg>
  ),
  huggingface: (props: IconProps) => (
    <svg role="img" viewBox="0 0 24 24" {...props}>
      ...
      <path
        fill="#000"
        d="M12 15c-2.333 0-4.5-1.167-4.5-3.5 0-1.333.667-2.5 2-2.5 1.333 0 2.5 1.167 2.5 2.5s1.167 2.5 2.5 2.5 2-1.167 2-2.5c0-2.333-2.167-3.5-4.5-3.5"
      />
      <circle cx="8.5" cy="10.5" r="1.5" fill="#000" />
      <circle cx="15.5" cy="10.5" r="1.5" fill="#000" />
      <path
        d="M8 16s2 2.5 4 2.5 4-2.5 4-2.5"
        fill="none"
        stroke="#000"
        strokeWidth="1.5"
        strokeLinecap="round"
  ...
  langchain: (props: IconProps) => (
    <svg role="img" viewBox="0 0 24 24" {...props}>
      ...
      <path
        fill="#339933"
        d="M12 4.5l-5.5 3.5v6l5.5 3.5 5.5-3.5v-6L12 4.5z"
      />
  ...
  langgraph: (props: IconProps) => (
    <svg role="img" viewBox="0 0 24 24" {...props}>
      ...
      <path
        ...
        d="M12 2L4 7v10l8 5 8-5V7l-8-5z"
      />
      <circle cx="12" cy="7" r="2" fill="#339933" />
      <circle cx="7" cy="15" r="2" fill="#339933" />
      <circle cx="17" cy="15" r="2" fill="#339933" />
      <path d="M12 9l-3 4M12 9l3 4M9 15h6" stroke="#339933" strokeWidth="1.5" />
    </svg>
  ),
    ...
    <svg role="img" viewBox="0 0 24 24" {...props}>
      ...
      <defs>
        <linearGradient id="gemini-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="100%" stopColor="#9A6AFF" />
        </linearGradient>
      </defs>
    </svg>
  ),
